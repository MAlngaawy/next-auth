...
import { Input as ShatcnInput } from '@/components/ui/input';
import { TextInput } from '@mantine/core';

const TailGridnput = () => {
  return (
    <section className=" rounded-xl bg-dark w-full">
      <div className="container">
        <div className="-mx-4 flex flex-wrap w-full p-5">
          {/*//! Tailgrid Input */}
          <DefaultColumn>
            <InputLabel text="TailGrid Input" />
            <input
              type="text"
              placeholder="Default Input"
              className="w-full bg-transparent rounded-md border text-white border-stroke dark:border-dark-3 py-[10px] px-5 outline-none transition focus:border-green-500 active:border-primary disabled:cursor-default disabled:bg-gray-2 disabled:border-gray-2"
            />
          </DefaultColumn>
          {/*//! MUI Input */}
          <DefaultColumn>
            <InputLabel text="MUI Input" />
            <TextField
              label="MUI Text Input"
              slotProps={{
                input: {
                  className: 'border focus:outline-none text-white',
                },
                inputLabel: {
          ...
          {/* //! shatcn */}
          <DefaultColumn>
            <InputLabel text="Shatcn Input" />
            <ShatcnInput
              className="border bg-transparent text-white border-green-400"
              type="email"
              placeholder="Email"
            />
          </DefaultColumn>
          {/* //! Antd */}
          <DefaultColumn>
            <InputLabel text="Antd Input" />
            <Input
              className="text-white border-green-500 bg-transparent hover:bg-transparent focus:bg-transparent focus:border-green-500 hover:border-green-500"
              size="large"
          ...
          <DefaultColumn>
            <TextInput
              ...
              classNames={{
                input:
                  'bg-transparent text-white border-green-500 focus:border-green-500',
                label: 'text-white',
              }}
            />
          </DefaultColumn>
...
export default TailGridnput;

const DefaultColumn = ({ children }: { children: ReactNode }) => {
  return (
...
const InputLabel = ({ text }: { text: string }) => {
  return (
    <label className="mb-[10px] block text-sm font-medium text-white dark:text-white">
      {text}
    </label>
  );
};
